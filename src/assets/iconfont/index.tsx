...
const IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    case 'iconsaoma':
      return <Iconsaoma key="1" {...rest} />;
    case 'iconxiangxia1':
      return <Iconxiangxia1 key="2" {...rest} />;
    case 'iconguanbi':
      return <Iconguanbi key="3" {...rest} />;
    case 'iconyinpinbofangqi_xiazaiwancheng_icon-':
      return <IconyinpinbofangqiXiazaiwanchengIcon key="4" {...rest} />;
    case 'iconicon-test1':
      return <IconiconTest1 key="5" {...rest} />;
    case 'iconhuojian1':
      return <Iconhuojian1 key="6" {...rest} />;
    case 'iconhuojian2':
      return <Iconhuojian2 key="7" {...rest} />;
    case 'iconrocket__easyi-copy':
      return <IconrocketEasyiCopy key="8" {...rest} />;
    case 'iconhuojian':
      return <Iconhuojian key="9" {...rest} />;
    case 'iconzuo':
      return <Iconzuo key="10" {...rest} />;
    case 'icontuichu':
      return <Icontuichu key="11" {...rest} />;
    case 'icontuichudenglu':
      return <Icontuichudenglu key="12" {...rest} />;
    case 'iconmenu':
      return <Iconmenu key="13" {...rest} />;
    case 'iconmenu1':
      return <Iconmenu1 key="14" {...rest} />;
    case 'iconmenu2':
      return <Iconmenu2 key="15" {...rest} />;
    case 'iconmenu3':
      return <Iconmenu3 key="16" {...rest} />;
    case 'iconmimabukejian':
      return <Iconmimabukejian key="17" {...rest} />;
    case 'iconmimakejian':
      return <Iconmimakejian key="18" {...rest} />;
    case 'iconzhengque':
      return <Iconzhengque key="19" {...rest} />;
    case 'iconxingmingyonghumingnicheng':
      return <Iconxingmingyonghumingnicheng key="20" {...rest} />;
    case 'iconmima':
      return <Iconmima key="21" {...rest} />;
    case 'iconhuanyingni':
      return <Iconhuanyingni key="22" {...rest} />;
    case 'iconzongyi':
      return <Iconzongyi key="23" {...rest} />;
    case 'icondongman':
      return <Icondongman key="24" {...rest} />;
    case 'iconhuiyuan':
      return <Iconhuiyuan key="25" {...rest} />;
    case 'icontinggeshiqu':
      return <Icontinggeshiqu key="26" {...rest} />;
    case 'iconhuiyuan1':
      return <Iconhuiyuan1 key="27" {...rest} />;
    case 'iconhuiyuan2':
      return <Iconhuiyuan2 key="28" {...rest} />;
    case 'iconhuiyuan3':
      return <Iconhuiyuan3 key="29" {...rest} />;
    case 'iconerjiyinletingge':
      return <Iconerjiyinletingge key="30" {...rest} />;
    case 'iconhuiyuan7':
      return <Iconhuiyuan7 key="31" {...rest} />;
    case 'iconhuiyuan4':
      return <Iconhuiyuan4 key="32" {...rest} />;
    case 'iconbofang1':
      return <Iconbofang1 key="33" {...rest} />;
    case 'iconshanchu':
      return <Iconshanchu key="34" {...rest} />;
    case 'iconshangyishou':
      return <Iconshangyishou key="35" {...rest} />;
    case 'iconxiayishou':
      return <Iconxiayishou key="36" {...rest} />;
    case 'iconzantingtingzhi':
      return <Iconzantingtingzhi key="37" {...rest} />;
    case 'iconbofang':
      return <Iconbofang key="38" {...rest} />;
    case 'iconarrow-down':
      return <IconarrowDown key="39" {...rest} />;
    case 'iconshijian':
      return <Iconshijian key="40" {...rest} />;
    case 'iconjia':
      return <Iconjia key="41" {...rest} />;
    case 'iconjian':
      return <Iconjian key="42" {...rest} />;
    case 'iconmeiyoushuju':
      return <Iconmeiyoushuju key="43" {...rest} />;
    case 'iconshengyin':
      return <Iconshengyin key="44" {...rest} />;
    case 'iconicon-test':
      return <IconiconTest key="45" {...rest} />;
    case 'iconshengyin1':
      return <Iconshengyin1 key="46" {...rest} />;
    case 'iconxihuan-':
      return <Iconxihuan key="47" {...rest} />;
    case 'iconxihuantianchong':
      return <Iconxihuantianchong key="48" {...rest} />;
    case 'iconziyuan':
      return <Iconziyuan key="49" {...rest} />;
    case 'icongengduo':
      return <Icongengduo key="50" {...rest} />;
    case 'iconfaxian':
      return <Iconfaxian key="51" {...rest} />;
    case 'iconiconfontxingxing':
      return <Iconiconfontxingxing key="52" {...rest} />;
    case 'iconzhanghao':
      return <Iconzhanghao key="53" {...rest} />;
    case 'iconren':
      return <Iconren key="54" {...rest} />;
    case 'iconshoucang':
      return <Iconshoucang key="55" {...rest} />;
    case 'iconyemian':
      return <Iconyemian key="56" {...rest} />;
    case 'iconyemian1':
      return <Iconyemian1 key="57" {...rest} />;
    case 'iconindex':
      return <Iconindex key="58" {...rest} />;
    case 'iconindex1':
      return <Iconindex1 key="59" {...rest} />;
  }
