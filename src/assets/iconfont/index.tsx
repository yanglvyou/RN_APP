...
import Iconeen from './Iconeen';
import Iconxiangxia2 from './Iconxiangxia2';
import Iconxiangxia from './Iconxiangxia';
...
const IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    case 'iconxiangxia1':
      return <Iconxiangxia1 key="1" {...rest} />;
    case 'iconeen':
      return <Iconeen key="2" {...rest} />;
    case 'iconxiangxia2':
      return <Iconxiangxia2 key="3" {...rest} />;
    case 'iconxiangxia':
      return <Iconxiangxia key="4" {...rest} />;
    case 'iconjiantouXia':
      return <IconjiantouXia key="5" {...rest} />;
    case 'iconguanbi':
      return <Iconguanbi key="6" {...rest} />;
    case 'iconyinpinbofangqi_xiazaiwancheng_icon-':
      return <IconyinpinbofangqiXiazaiwanchengIcon key="7" {...rest} />;
    case 'iconicon-test1':
      return <IconiconTest1 key="8" {...rest} />;
    case 'iconhuojian1':
      return <Iconhuojian1 key="9" {...rest} />;
    case 'iconhuojian2':
      return <Iconhuojian2 key="10" {...rest} />;
    case 'iconrocket__easyi-copy':
      return <IconrocketEasyiCopy key="11" {...rest} />;
    case 'iconhuojian':
      return <Iconhuojian key="12" {...rest} />;
    case 'iconzuo':
      return <Iconzuo key="13" {...rest} />;
    case 'icontuichu':
      return <Icontuichu key="14" {...rest} />;
    case 'icontuichudenglu':
      return <Icontuichudenglu key="15" {...rest} />;
    case 'iconmenu':
      return <Iconmenu key="16" {...rest} />;
    case 'iconmenu1':
      return <Iconmenu1 key="17" {...rest} />;
    case 'iconmenu2':
      return <Iconmenu2 key="18" {...rest} />;
    case 'iconmenu3':
      return <Iconmenu3 key="19" {...rest} />;
    case 'iconmimabukejian':
      return <Iconmimabukejian key="20" {...rest} />;
    case 'iconmimakejian':
      return <Iconmimakejian key="21" {...rest} />;
    case 'iconzhengque':
      return <Iconzhengque key="22" {...rest} />;
    case 'iconxingmingyonghumingnicheng':
      return <Iconxingmingyonghumingnicheng key="23" {...rest} />;
    case 'iconmima':
      return <Iconmima key="24" {...rest} />;
    case 'iconhuanyingni':
      return <Iconhuanyingni key="25" {...rest} />;
    case 'iconzongyi':
      return <Iconzongyi key="26" {...rest} />;
    case 'icondongman':
      return <Icondongman key="27" {...rest} />;
    case 'iconhuiyuan':
      return <Iconhuiyuan key="28" {...rest} />;
    case 'icontinggeshiqu':
      return <Icontinggeshiqu key="29" {...rest} />;
    case 'iconhuiyuan1':
      return <Iconhuiyuan1 key="30" {...rest} />;
    case 'iconhuiyuan2':
      return <Iconhuiyuan2 key="31" {...rest} />;
    case 'iconhuiyuan3':
      return <Iconhuiyuan3 key="32" {...rest} />;
    case 'iconerjiyinletingge':
      return <Iconerjiyinletingge key="33" {...rest} />;
    case 'iconhuiyuan7':
      return <Iconhuiyuan7 key="34" {...rest} />;
    case 'iconhuiyuan4':
      return <Iconhuiyuan4 key="35" {...rest} />;
    case 'iconbofang1':
      return <Iconbofang1 key="36" {...rest} />;
    case 'iconshanchu':
      return <Iconshanchu key="37" {...rest} />;
    case 'iconshangyishou':
      return <Iconshangyishou key="38" {...rest} />;
    case 'iconxiayishou':
      return <Iconxiayishou key="39" {...rest} />;
    case 'iconzantingtingzhi':
      return <Iconzantingtingzhi key="40" {...rest} />;
    case 'iconbofang':
      return <Iconbofang key="41" {...rest} />;
    case 'iconarrow-down':
      return <IconarrowDown key="42" {...rest} />;
    case 'iconshijian':
      return <Iconshijian key="43" {...rest} />;
    case 'iconjia':
      return <Iconjia key="44" {...rest} />;
    case 'iconjian':
      return <Iconjian key="45" {...rest} />;
    case 'iconmeiyoushuju':
      return <Iconmeiyoushuju key="46" {...rest} />;
    case 'iconshengyin':
      return <Iconshengyin key="47" {...rest} />;
    case 'iconicon-test':
      return <IconiconTest key="48" {...rest} />;
    case 'iconshengyin1':
      return <Iconshengyin1 key="49" {...rest} />;
    case 'iconxihuan-':
      return <Iconxihuan key="50" {...rest} />;
    case 'iconxihuantianchong':
      return <Iconxihuantianchong key="51" {...rest} />;
    case 'iconziyuan':
      return <Iconziyuan key="52" {...rest} />;
    case 'icongengduo':
      return <Icongengduo key="53" {...rest} />;
    case 'iconfaxian':
      return <Iconfaxian key="54" {...rest} />;
    case 'iconiconfontxingxing':
      return <Iconiconfontxingxing key="55" {...rest} />;
    case 'iconzhanghao':
      return <Iconzhanghao key="56" {...rest} />;
    case 'iconren':
      return <Iconren key="57" {...rest} />;
    case 'iconshoucang':
      return <Iconshoucang key="58" {...rest} />;
    case 'iconyemian':
      return <Iconyemian key="59" {...rest} />;
    case 'iconyemian1':
      return <Iconyemian1 key="60" {...rest} />;
    case 'iconindex':
      return <Iconindex key="61" {...rest} />;
    case 'iconindex1':
      return <Iconindex1 key="62" {...rest} />;
  }
